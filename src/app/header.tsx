...
const Header = () => {
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-200">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul
            className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 
                      ...
                      md:dark:bg-gray-200 dark:border-gray-700"
          >
            <li>
              <a
                href="/"
                className="block py-2 px-3 text-white bg-gray-700 rounded md:bg-transparent md:text-gray-700 
                        md:p-0 dark:text-white md:dark:text-red-700"
                aria-current="page"
              >
                Home
              </a>
            ...
            <li>
              <a
                ...
                className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent
                        md:border-0 md:hover:text-gray-700 md:p-0 dark:text-black md:dark:hover:text-gray-500
      ...
      <div className="bg-red-400 h-1">
        {/* <div><marquee scrolldelay="500" direction="up"><div className="bg-gray-400 h-2 mt-1" ></div></marquee>
            </div> */}
      </div>
    </nav>
  );
